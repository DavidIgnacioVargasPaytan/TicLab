...
{
  "version": 1,
  "author": "DAVID IGNACIO VARGAS PAYTAN",
  "editor": "wokwi",
  "parts": [
    { "type": "wokwi-arduino-mega", "id": "mega", "top": 0, "left": 0, "attrs": {} },
    { "type": "wokwi-potentiometer", "id": "pot1", "top": 209.9, "left": 211, "attrs": {} },
    {
      "type": "wokwi-hc-sr04",
      "id": "ultrasonic1",
      "top": 203.1,
    ...
    },
    {
      ...
      "top": 190,
      "left": 307.2,
      "attrs": { "hornColor": "black", "horn": "double" }
    },
    { "type": "wokwi-ds3231", "id": "rtc1", "top": 200, "left": 400, "attrs": {} }
  ],
  "connections": [
    [ "rtc1:GND", "mega:GND.1", "black", [ "v0" ] ],
    [ "rtc1:VCC", "mega:5V", "red", [ "v0" ] ],
    [ "rtc1:SDA", "mega:20", "green", [ "v0" ] ],
    [ "rtc1:SCL", "mega:21", "blue", [ "v0" ] ],
    [ "ultrasonic1:VCC", "mega:5V", "red", [ "v0" ] ],
    [ "ultrasonic1:GND", "mega:GND.2", "black", [ "v0" ] ],
    [ "ultrasonic1:TRIG", "mega:7", "green", [ "v0" ] ],
    [ "ultrasonic1:GND", "mega:6", "black", [ "v0" ] ],
    [ "pot1:GND", "mega:GND.3", "black", [ "v0" ] ],
    [ "pot1:VCC", "mega:5V", "red", [ "v0" ] ],
    [ "pot1:SIG", "mega:A0", "green", [ "v0" ] ],
    [ "lcd1:VCC", "mega:5V", "red", [ "h-67.2", "v172.9" ] ],
